// cburnett chess pieces — Colin M.L. Burnett, CC-BY-SA 3.0
// Source: lichess-org/lila, Wikimedia Commons
...
const PIECES = { wK, bK, wQ, bQ, wR, bR, wB, bB, wN, bN, wP, bP }

export default function PieceSVG({ piece }) {
  const isWhite = piece === piece.toUpperCase()
  const key = (isWhite ? 'w' : 'b') + piece.toUpperCase()
